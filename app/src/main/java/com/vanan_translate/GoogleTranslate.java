...
public class GoogleTranslate {
    ...
    public static void main(String[] args) {
        ...
        GoogleTranslate translator = new GoogleTranslate("AIzaSyD7LLMujHvSPStAu6-9B9fGjNURaszWkeM");//change it to your own apikey generated by google
    ...
    String translte(String text, String from, String to) {
        ...
        try {
            ...
            if (conn.getResponseCode() != 200) {
                ...
                String ss = "Error Msg: Bad Language pair.";
                return ss;
            }
