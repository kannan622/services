...
public class Adapter_card_listview1 extends BaseAdapter {

    Context c;
    List<offer_model1> players = null;
    // CustomFilter filter;
    ArrayList<offer_model1> filterList;
    boolean isSet;
    SessionManager session;
    Adapter_card_listview1 myAdapter;
    private boolean isSelected[];
    private int selectedPosition = -1;
    private ArrayList<offer_model1> arraylist;


    public Adapter_card_listview1(Context ctx, List<offer_model1> players) {
        // TODO Auto-generated constructor stub

        this.c = ctx;
        this.players = players;

        this.arraylist = new ArrayList<offer_model1>();
    ...
    public View getView(final int pos, View convertView, ViewGroup parent) {
        // TODO Auto-generated method stub
        myAdapter = new Adapter_card_listview1(c, players);
        ...
        rel_val.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                session.create_to_lang(players.get(pos).getid(), players.get(pos).getlanguage_name(), players.get(pos).getlanguage_code(), players.get(pos).getflag());
        ...
        if (session.getUserDetails().get(SessionManager.KEY_to_flag_id) != null) {

            String ss = session.getUserDetails().get(SessionManager.KEY_to_flag_id);


            String myString = ss;
            int foo = Integer.parseInt(myString);

            // Log.d("session value ", "" + foo + "::::" + pos + "::::::" + selectedPosition);
    ...
    private View.OnClickListener onStateChangedListener(final CheckBox checkBox, final int position) {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                session.to_status_check(to_check);
                session.create_to_lang(players.get(position).getid(), players.get(position).getlanguage_name(), players.get(position).getlanguage_code(), players.get(position).getflag());
